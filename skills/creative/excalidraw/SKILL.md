...
- **For dark mode system architecture diagrams (multi-layer stacks), see `references/dark-mode-architecture.md`** — includes semantic layer-to-color mapping, zone opacity rules, and ONEBOT 3.0 example
